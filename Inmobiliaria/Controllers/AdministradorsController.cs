...
namespace Inmobiliaria.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        public AdministradorsController(InmobiliariaDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,user,pass")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,user,pass")] Administrador administrador)
        {
        ...
        public ActionResult Login(String usuario, String contrasena) 
        {
            ...
            var consulta =  from Administrador in _context.Administrador
                            where Administrador.user == usuario
                            select Administrador;

            var elusuario = consulta.FirstOrDefault<Administrador>();
